package irisdeltaj.simplerelationalsearchtag.br.unb.cic.iris.mail.provider;

import java.util.List;
import irisdeltaj.simplerelationalsearchtag.br.unb.cic.iris.core.BaseManager;
import irisdeltaj.simplerelationalsearchtag.br.unb.cic.iris.mail.EmailProvider;
import
irisdeltaj.simplerelationalsearchtag.br.unb.cic.iris.mail.provider.GmailProvider;
import
irisdeltaj.simplerelationalsearchtag.br.unb.cic.iris.mail.provider.YahooProvider;
import
irisdeltaj.simplerelationalsearchtag.br.unb.cic.iris.mail.provider.OutlookProvider;
