package irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.core;
...
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.core.model.Status;
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.i18n.MessageBundle;
import
...
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.mail.EmailClient;
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.mail.EmailProvider;
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.mail.IEmailClient;
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.mail.provider.DefaultProvider;
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.mail.provider.ProviderManager;
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.persistence.IEmailDAO;
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.persistence.relational.EmailDAO;
import
irisdeltaj.simplerelationalsearchaddressbook.br.unb.cic.iris.persistence.relational.FolderDAO;
import
...
dAddressBookRelational* modified by dAddressBookFacade* modified by
dSearchFacade
 */
