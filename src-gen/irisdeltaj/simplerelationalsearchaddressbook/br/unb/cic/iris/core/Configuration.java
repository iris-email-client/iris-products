...
public class Configuration {
	...
	public static final String PROVIDER_TRANSPORT_PROTOCOL =
	"provider.transport.protocol";
	public static final String PROVIDER_TRANSPORT_HOST =
	"provider.transport.host";
	public static final String PROVIDER_TRANSPORT_PORT =
	"provider.transport.port";
	public static final String PROVIDER_STORE_PROTOCOL =
