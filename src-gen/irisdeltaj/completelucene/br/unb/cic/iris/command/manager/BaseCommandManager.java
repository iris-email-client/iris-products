package irisdeltaj.completelucene.br.unb.cic.iris.command.manager;

import irisdeltaj.completelucene.br.unb.cic.iris.i18n.MessageBundle;
import java.util.HashSet;
import java.util.List;
import java.util.Set;
import irisdeltaj.completelucene.br.unb.cic.iris.command.CommandListener;
import irisdeltaj.completelucene.br.unb.cic.iris.command.ICommandManager;
import irisdeltaj.completelucene.br.unb.cic.iris.command.MailCommand;
