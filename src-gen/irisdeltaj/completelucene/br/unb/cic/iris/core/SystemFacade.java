...
import irisdeltaj.completelucene.br.unb.cic.iris.core.model.Status;
...
import irisdeltaj.completelucene.br.unb.cic.iris.core.exception.EmailUncheckedException;
...
import irisdeltaj.completelucene.br.unb.cic.iris.mail.EmailClient;
import irisdeltaj.completelucene.br.unb.cic.iris.mail.EmailProvider;
import irisdeltaj.completelucene.br.unb.cic.iris.mail.IEmailClient;
import irisdeltaj.completelucene.br.unb.cic.iris.mail.provider.DefaultProvider;
import irisdeltaj.completelucene.br.unb.cic.iris.mail.provider.ProviderManager;
...
import irisdeltaj.completelucene.br.unb.cic.iris.persistence.lucene.AddressBookDAO;
import irisdeltaj.completelucene.br.unb.cic.iris.core.model.AddressBookEntry;

/***
 * added by dBaseFacade* modified by dPersistenceLucene* modified by
 * dAddressBookLucene* modified by dAddressBookFacade* modified by dSearchFacade
 */
