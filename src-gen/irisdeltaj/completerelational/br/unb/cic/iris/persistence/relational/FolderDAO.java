...
import irisdeltaj.completerelational.br.unb.cic.iris.persistence.IFolderDAO;
...
public class FolderDAO extends AbstractDAO<IrisFolder> implements IFolderDAO {
	...
	public IrisFolder findByName(String folderName) throws DBException {
		try {
			...
			handleException(new DBException(MessageBundle.message("error.folder.not.found", folderName), e));
		} finally {
			closeSession();
		}
		return null;
