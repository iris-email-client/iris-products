...
import irisdeltaj.completerelational.br.unb.cic.iris.reflect.ClassFinder;
...
public abstract class AbstractCommandManager extends BaseCommandManager {
	...
	private void loadClasspathCommands()
			throws ClassNotFoundException, InstantiationException, IllegalAccessException, EmailException {
