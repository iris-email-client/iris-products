...
import irisdeltaj.completerelational.br.unb.cic.iris.util.StringUtil;
import irisdeltaj.completerelational.br.unb.cic.iris.command.MailCommand;
import irisdeltaj.completerelational.br.unb.cic.iris.command.manager.AbstractCommandManager;
import irisdeltaj.completerelational.br.unb.cic.iris.core.exception.EmailException;
import irisdeltaj.completerelational.br.unb.cic.iris.core.exception.EmailMessageValidationException;
